...
// staticPagesWritingHtml reads file data from disk. It returns an error on failure.
func staticPagesWritingHtml() (*asset, error) {
	path := "/home/al/go_stu/ddns/myddns/static/pages/writing.html"
	name := "static/pages/writing.html"
